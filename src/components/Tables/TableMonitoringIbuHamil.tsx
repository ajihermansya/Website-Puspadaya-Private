...
const statusColors: { [key: string]: string } = {
  "MenjelangPersalinan": "bg-red-500",
};

const TableMonitoringIbuHamil: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      const dummyData: DataRow[] = Array.from({ length: 30 }, (_, index) => ({
        id: index + 1,
        contact_ref: `Nama Ibu Hamil ${index + 1}`, // Nama Balita
    ...
    return (
      <div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
        <div className="flex space-x-2">
          <Link
            href={`/monitoring/monitoring-ibu-hamil/view`}
            passHref
        ...
        <div className="mb-6 flex flex-col justify-between md:flex-row md:items-center">
          <div className="md:mb-0">
            ...
            <p className="text-sm font-light text-gray-5">
              Monitoring perkembangan kesehatan ibu hamil 
            </p>
          </div>
...
export default TableMonitoringIbuHamil;
