"use client";
import GrafikTumbuhKembangBalita from "@/components/Charts/GrafikTumbuhKembangBalita";
      ...
      <div className="rounded-lg bg-white p-6 shadow-md">
        <form onSubmit={handleSubmit}>
                ...
                <div className="w-1/2">
                  ...
                  <div className="relative">
                    <InputText
                      ...
                      onChange={handleInputChange}
                      className="w-full rounded-md border border-gray-300 p-2 pr-12 outline-none placeholder:text-xs focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                      placeholder="Masukkan Tinggi Badan"
                    />
                    <span className="absolute inset-y-0 right-0 flex items-center rounded-r-md border-l border-gray-300 bg-gray-200 px-2 text-gray-500">
                      Cm
                    </span>
                  </div>
          ...
          <div style={{ width: "80%", margin: "0 auto", paddingTop: "10px" }}>
            ...
            >
              Grafik Berat dan Tinggi Badan Balita - Pemantauan Tumbuh Kembang
            </h2>
